...
path = r'E:\dl_monalisa\Data\Vim_fixed_mltplSNR_30nm\SNR\onPred'
list_files = ["Pred"]
pxSize = 30 #nm

# line profiles plots parameters
do_plots = True # put false if you don't need to show or save all the line profiles plots
show_plots = True # to show all line profiles at the end of each dataset processing
...
save_box_plot = False
# saved_title = "SNR_Distribution_fixedDataset.svg"
...
box_plot_parameters = {
    "colors": None, 
    "widths": 0.3,
    "positions": [0.2,0.8,1.3], # positions of the boxes on the x-axis
    "linewidth": 2,
    ...
    "xlabel": "SNR level",
    "ylabel": "Measured SNR",
    "title": "SNR measurements (w/ line profiles)",
    "use_mean": True,
}
...
for f in list_files:
    ...
    for i in range(1, 2):
        file = f"LineProfiles_{f}_c14.txt"
...
# do box plot
fig=box_plot(snrs_all,list_files,**box_plot_parameters)
plt.show()
